...
import io
from utils.frames import LeagueTable, MatchdayFrame, News, StatsFrame, CompStats
...
class LeagueProfile(ctk.CTkFrame):
    def __init__(self, parent, league_id = None, changeBackFunction = None, userLeagueProfile = None):
        ...
        self.classNames = [Profile, Matchdays, Graphs, CompStats, News, History]
...
class Profile(ctk.CTkFrame):
    def __init__(self, parent, league):
        ...
        self.statsFrame = StatsFrame(self, self.league.id, 310, 480, GREY_BACKGROUND, 0.64, 0.2, "nw")
