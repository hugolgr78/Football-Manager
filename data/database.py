...
class PlayerAttributes(Base):
    ...
    id = Column(String(256), primary_key = True, default = lambda: str(uuid.uuid4()))
    player_id = Column(String(128), ForeignKey('players.id'))
    diving = Column(Integer, nullable = False, default = 0)
    ...
    attack_position = Column(Integer, nullable = False, default = 0)
    ...
    sprint_speed = Column(Integer, nullable = False, default = 0)
    ...
    ball_control = Column(Integer, nullable = False, default = 0)
    crossing = Column(Integer, nullable = False, default = 0)
    curve = Column(Integer, nullable = False, default = 0)
    ...
    long_passing = Column(Integer, nullable = False, default = 0)
    ...
    short_passing = Column(Integer, nullable = False, default = 0)
    shot_power = Column(Integer, nullable = False, default = 0)
    tackling_slide = Column(Integer, nullable = False, default = 0)
    tackling_stand = Column(Integer, nullable = False, default = 0)
    volleys = Column(Integer, nullable = False, default = 0)
