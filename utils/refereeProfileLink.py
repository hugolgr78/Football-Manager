...
class RefereeProfileLabel(ctk.CTkFrame):
    def __init__(self, parent, referee, referee_name, prefix_text, suffix_text, width, height, tab, textColor = "white", fg_color = TKINTER_BACKGROUND, fontSize = 20):
        """
        A label that displays a referee profile link with prefix and suffix text.
        
        Args:
            parent (ctk.CTkFrame): The parent frame where the label will be placed.
            referee (Referee): The referee object associated with this link.
            referee_name (str): The name of the referee to be displayed as a link.
            prefix_text (str): The text to display before the referee link.
            suffix_text (str): The text to display after the referee link.
            width (int): The width of the label frame.
            height (int): The height of the label frame.
            tab (ctk.CTkFrame): The tab frame where the referee profile will be displayed.
...
class RefereeProfileLink(ctk.CTkLabel):
    def __init__(self, parent, referee, text, textColor, relx, rely, anchor, fg_color, tab, fontSize = 20):
        """
        A clickable label that opens the referee profile when clicked.
        
        Args:
            parent (ctk.CTkFrame): The parent frame where the label will be placed.
            referee (Referee): The referee object associated with this link.
            text (str): The text to be displayed as the referee link.
    ...
    def openPlayerProfile(self, event):
        """
        Opens the referee profile tab for the associated referee.
        """
    ...
    def changeBack(self):
        """
        Closes the referee profile tab.
        """
